# LangGraph Agent Backend - Bridge To Works (v3.0)

This is the **production-ready LangGraph agent** (v3.0, January 2026) that powers the Bridge To Works recruitment platform's AI chat interface.
